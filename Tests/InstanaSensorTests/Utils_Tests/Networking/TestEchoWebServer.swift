...
extension TestEchoWebServer.HTTPHandler {
    enum State {
        case idle
...
extension URLRequest {
    public init(_ request: TestEchoWebServer.HTTPHandler.Request) {
...
public typealias Middleware = (
    _ request: TestEchoWebServer.HTTPHandler.Request,
    _ response: TestEchoWebServer.HTTPHandler.Response,
    _ next: @escaping () -> Void
) -> Void

/// Middleware that can redirect requests to other middlewares
public func router(
    route: @escaping (TestEchoWebServer.HTTPHandler.Request) -> Middleware?,
...
public func redirect(
    ...
    request redirect: @escaping (TestEchoWebServer.HTTPHandler.Request) -> TestEchoWebServer.HTTPHandler.Request,
    response intercept: @escaping (TestEchoWebServer.HTTPHandler.Response) -> Void = { _ in }
) -> Middleware {
    return { request, response, next in
