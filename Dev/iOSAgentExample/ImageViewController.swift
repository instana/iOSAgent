...
class ImageViewViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        Instana.reportEvent(name: "Custom Event", duration: "1001.01", backendTracingID: nil, error: NSError(domain: "Domain", code: 0, userInfo: nil), meta: ["Key": "Val"], viewName:"Image")
    }
