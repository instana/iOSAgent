...
enum HTTPError: RawRepresentable, CustomStringConvertible, Equatable {
    ...
    var rawValue: String {
        ...
        case .appTransportSecurityRequiresSecureConnection: return "ATS Requires SSL"
    ...
    var description: String {
        ...
        // swiftlint:disable:next line_length
        case .appTransportSecurityRequiresSecureConnection: return "The resource could not be loaded because the App Transport Security policy requires the use of a secure connection."
    ...
    init?(error: NSError?, statusCode: Int? = nil) {
        ...
        case NSURLErrorAppTransportSecurityRequiresSecureConnection: self = .appTransportSecurityRequiresSecureConnection
